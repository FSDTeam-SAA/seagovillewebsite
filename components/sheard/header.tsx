      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/builder" className="text-foreground hover:text-primary transition-colors">
              Create Your Own
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button className="hidden sm:inline-flex bg-primary hover:bg-primary/90">Order Now</Button>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden pb-4 space-y-2 border-t border-border">
            ...
            <Link href="/menu" className="block px-4 py-2 text-foreground hover:bg-secondary rounded">
              Menu
            </Link>
            <Link href="/builder" className="block px-4 py-2 text-foreground hover:bg-secondary rounded">
              Create Your Own
            </Link>

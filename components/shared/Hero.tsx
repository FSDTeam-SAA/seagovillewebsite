          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            ...
            <Link href="/menu" className="sm:flex-1">
              <Button
                size="lg"
                variant="outline"
                className="w-full cursor-pointer bg-[#D62828] rounded-none hover:bg-[#d62828fa] hover:text-white text-white border-none  font-medium text-sm md:text-base leading-[150%]  "
              >
                Explore Menu
              </Button>
            </Link>

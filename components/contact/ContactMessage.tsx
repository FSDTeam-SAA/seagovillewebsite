      ...
      <div className="bg-gray-50 py-10" id="get-in-touch">
        <div className="container mx-auto bg-white rounded-2xl shadow-sm grid grid-cols-1 md:grid-cols-2">
              ...
              >
                ...
                <div className="flex justify-center w-full">
                  <button
                    type="submit"
                    disabled={loading}
                    className="border border-yellow-500  text-white px-6 py-3 rounded-md font-semibold w-full sm:w-auto cursor-pointer transition-all duration-300 bg-[#D62828] hover:bg-yellow-500 disabled:bg-gray-400 disabled:cursor-not-allowed"
                  >
          ...
          <div className="relative h-96 md:h-auto rounded-l-2xl overflow-hidden space-y-5 p-5">
            ...
            {/* Google Map */}
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3359.382474606465!2d-96.54896888783355!3d32.64926469039272!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x864eb0c5555f026b%3A0xae0620cbdd4038d!2zMjA4IEhhbGwgUmQsIFNlYWdvdmlsbGUsIFRYIDc1MTU5LCDgpq7gpr7gprDgp43gppXgpr_gpqgg4Kav4KeB4KaV4KeN4Kak4Kaw4Ka-4Ka34KeN4Kaf4KeN4Kaw!5e0!3m2!1sbn!2sbd!4v1763749478580!5m2!1sbn!2sbd"
              width="600"
              height="450"
              style={{ border: 0 }}
              loading="lazy"

...
export default function MenuPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = usePizzasByCategoryQuery(activeCategory === "all" ? null : activeCategory)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <PizzaFilterTabs activeCategory={activeCategory} onCategoryChange={setActiveCategory} />
          ...
          {error && (
            <div className="text-center py-12">
              <p className="text-lg text-destructive mb-4">Error loading pizzas. Please try again.</p>
            </div>
          )}
          ...
          {!isLoading && !error && (
            <>
              ...
              {pizzas.length === 0 && (
                <div className="text-center py-12">
                  <p className="text-lg text-muted-foreground mb-4">No pizzas found in this category</p>
      ...
      <section className="bg-primary text-primary-foreground py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Create Your Own Pizza</h2>
